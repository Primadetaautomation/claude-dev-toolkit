# 🎯 Codex Coding Principes (CLAUDE Framework)
Deze richtlijnen zijn een Codex-geoptimaliseerde kopie van de CLAUDE regels. Gebruik ze als standaard wanneer je met de OpenAI Codex CLI werkt zodat alle sub-agents dezelfde kwaliteits- en veiligheidsverwachtingen volgen.
